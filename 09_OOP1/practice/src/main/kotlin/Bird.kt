class Bird(energy: Int, weight: Int, currentAge: Int, maxAge: Int, name: String) :
    Animal(energy, weight, currentAge, maxAge, name) {
    override fun move(message: String) {
        super.move("$name flying")
    }

    override fun giveOffspring(energy: Int, weight: Int, currentAge: Int, maxAge: Int, name: String): Bird {
